...
- **Barrados por inglês:** com "online", "home office" e "feedback" liberados (Regra 17), só `jogos-online-criancas` segue pulado — por "Free Fire" (nome do jogo).
- **Selo da capa:** categoria "Geral" não aparece — vira o tema do título (`TEMAS_SELO` em capaRedes.js, ex.: "Professores") ou some. Modelo atual: `capa-4x5-v2`.
